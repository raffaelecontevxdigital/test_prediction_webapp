...
function AreaRiservata() {
    ...
    useEffect(() => {
        async function trovaRisultato() {
            await APIRequest('GET', 'segnalazione/')
                .then(res => {
                    setResults(res.data);
                }).catch((e) => {
                    console.log(e)
    ...
    const saveResult = async () => {
        ...
        await APIRequest('PUT', `segnalazione/?id=${result.id}`, result)
            .then(res => {
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <h4 className="textWhite m-0">Gestione segnalazioni</h4>
        ...
        <div className='fitBody'>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={results}
                    ...
                    <Column field="createAt" header="Data" body={createAtBodyTemplate} sortable ></Column>
